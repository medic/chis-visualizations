1.	Steps to setup and run ETL pipeline.
    ...
    c.	Create target star schema tables and views using the queries present in star_schema_tables.sql.
    d.	Create meta data table as provided in meta_data_details.sql 
